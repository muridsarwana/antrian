...
<body class="d-flex flex-column h-100">
        ...
        <div class="col-lg mb-4">
          ...
          <div class="row mb-4">
            <div class="col-lg-4">
              ...
              <div class="card border-5 shadow-sm mb-4 border-success">
                <a id="insert_1sek" href="javascript:void(0)" class="btn btn-block fs-5 px-1 py-1 mb-2">
            ...
            <div class="col-lg-4">
              <!-- 2. Pembinaan SMA -->
              <div class="card border-5 shadow-sm mb-4 border-success">
                <a id="insert_2sma" href="javascript:void(0)" class="btn btn-block fs-5 px-1 py-1 mb-2">
            ...
            <div class="col-lg-4">
              <!-- 3. Pembinaan SMK -->
              <div class="card border-5 shadow-sm mb-4 border-success">
                <a id="insert_3smk" href="javascript:void(0)" class="btn btn-block fs-5 px-1 py-1 mb-2">
                  <div class="card-body text-center d-grid p-3">
          ...
          <div class="row mb-4">
            <div class="col-lg-4">
              <!-- 4. Pembinaan DIKSUS -->
              <div class="card border-5 shadow-sm mb-4 border-success">
                <a id="insert_4slb" href="javascript:void(0)" class="btn btn-block fs-5 px-1 py-1 mb-2">
                  <div class="card-body text-center d-grid p-3">
            ...
            <div class="col-lg-4">
              ...
              <div class="card border-5 shadow-sm mb-4 border-success">
                <a id="insert_5bud" href="javascript:void(0)" class="btn btn-block fs-5 px-1 py-1 mb-2">
                  <div class="card-body text-center d-grid p-3">
            ...
            <div class="col-lg-4">
              <!-- 6. Ketenagaan -->
              <div class="card border-5 shadow-sm mb-4 border-success">
                <a id="insert_6ket" href="javascript:void(0)" class="btn btn-block fs-5 px-1 py-1 mb-2">
                  <div class="card-body text-center d-grid p-3">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#insert_1sek').on('click', function() {
        var x_value = 'SEKRETARIAT';
        var y_value = $('#antrian_1sek').text();
        $.ajax({
          type: 'GET',
